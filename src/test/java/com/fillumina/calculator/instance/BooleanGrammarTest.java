...
public class BooleanGrammarTest {
    ...
    @Test
    public void shouldRecognizeAVariableIncludingTheTextTRUE() {
        context.put("VERYTRUE", Boolean.TRUE);
        assertEvaluateTo(false, "NOT VERYTRUE");
    }

    @Test
    public void shouldRecognizeAVariableIncludingTheTextFALSE() {
        context.put("ORFALSE", Boolean.FALSE);
        assertEvaluateTo(true, "NOT ORFALSE");
    }
